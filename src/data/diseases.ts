...
export const diseases: Disease[] = [
  ...
  {
    slug: "msa-c",
    name: "多系統萎縮症・小脳型（MSA-C）",
    nameEn: "Multiple System Atrophy - Cerebellar Type",
    nanbyoNumber: 17,
    category: "神経・筋疾患",
    categorySlug: "neurological",
    overview:
      "多系統萎縮症（MSA）のうち小脳性運動失調が主症状のサブタイプ。自律神経障害（起立性低血圧・排尿障害）を必ず伴い、パーキンソニズムより小脳症状が前景に立つ。オリーブ橋小脳萎縮症（OPCA）とも呼ばれた。日本人に比較的多い。",
    symptoms: [
      "小脳性運動失調（歩行失調・四肢失調・構音障害）",
      "起立性低血圧（立ちくらみ・失神）",
      "排尿障害（尿失禁・残尿・頻尿）",
      "構音障害・嚥下障害",
      "REM睡眠行動障害",
    ...
    causes:
      "α-シヌクレイン（αSyn）がオリゴデンドロサイトに蓄積（グリア細胞質封入体：GCI）し、脳幹・小脳・脊髄の神経細胞変性を引き起こす。孤発性で遺伝因子は特定されていない。",
    diagnosis:
      "臨床診断基準（Gilman 2008）：自律神経障害＋小脳性運動失調（±パーキンソニズム）。MRI（橋・小脳萎縮、hot cross bun sign）。脳血流SPECT。自律神経機能検査。確定診断は剖検による病理（GCI）。",
    treatment:
      "根本治療なし。対症療法：起立性低血圧（弾性ストッキング・フルドロコルチゾン・ミドドリン）、排尿障害（抗コリン薬・間欠自己導尿）、リハビリテーション。",
    prognosis:
      "発症から平均6〜9年で死亡。嚥下障害・呼吸障害・誤嚥性肺炎が主な死因。",
    jrctSearchUrl:
      "https://jrct.niph.go.jp/search?query=Multiple+System+Atrophy+Cerebellar",
    nanbyouInfoUrl: "https://www.nanbyou.or.jp/entry/214",
  },
  {
    slug: "drpla",
  ...
  {
    slug: "primary-ciliary-dyskinesia-kartagener",
    name: "カルタゲナー症候群（原発性線毛機能不全）",
    nameEn: "Kartagener Syndrome / Primary Ciliary Dyskinesia",
    nanbyoNumber: 255,
    category: "呼吸器疾患",
    categorySlug: "respiratory",
    overview:
      "線毛の構造・機能異常による常染色体劣性疾患。気管支拡張症・慢性副鼻腔炎・内臓逆位の三徴（カルタゲナー症候群）を特徴とするが、内臓逆位を伴わない原発性線毛機能不全も含む広義の疾患群。",
    symptoms: [
      "慢性湿性咳嗽・気管支拡張症",
      "慢性副鼻腔炎・鼻ポリープ",
      "内臓逆位（50%）",
    ...
    causes:
      "DNAI1・DNAI2・DNAAF1・CCDC39・CCDC40等の線毛軸糸ダイニン・線毛構造タンパク遺伝子の両アレル性病的バリアント。常染色体劣性遺伝。外ダイニンアーム欠失が最多（電顕所見）。",
    diagnosis:
      "鼻腔一酸化窒素（nNO）低値（スクリーニング）・線毛電子顕微鏡（軸糸構造異常）・線毛機能動画解析・遺伝子パネル検査・高分解能胸部CT・内臓位置確認。",
    treatment:
      "気道クリアランス（物理療法・振動PEPマスク）・慢性感染症への抗菌薬療法・吸入気管支拡張薬。副鼻腔炎管理・補聴器・男性不妊には補助生殖技術。",
    prognosis:
      "慢性気道感染・気管支拡張症が生涯進行するが、積極的な気道管理で呼吸機能低下を遅らせることが可能。肺移植が末期例の選択肢。",
    jrctSearchUrl:
      "https://jrct.niph.go.jp/search?query=Primary+Ciliary+Dyskinesia",
    nanbyouInfoUrl: "https://www.nanbyou.or.jp/entry/4828",
  },
  {
  ...
  },
  {
    ...
    categorySlug: "digestive",
    overview:
      "胃・小腸・大腸に好酸球が異常浸潤し、腹痛・下痢・嘔吐・吸収不良・蛋白漏出性腸症をきたす疾患。粘膜型・筋層型・漿膜型（腹水型）に分類される。アレルギー素因（アトピー・食物アレルギー）を持つ患者に多い。好酸球性食道炎と合併する場合がある。",
    symptoms: ["腹痛", "嘔吐", "下痢", "腹水（漿膜型）", "体重減少", "低アルブミン血症", "鉄欠乏性貧血"],
    causes: "食物アレルゲン・環境アレルゲンへの過感受性、IL-5・エオタキシン等による好酸球遊走亢進。",
    diagnosis: "消化管生検（好酸球>20/高倍率視野）、血液好酸球増多、内視鏡（粘膜浮腫・潰瘍）、腹部CT（腹水）。",
    treatment: "除去食療法、副腎皮質ステロイド（プレドニゾロン）が主体。モンテルカスト・クロモグリク酸ナトリウム補助。",
    prognosis: "再発を繰り返す慢性経過が多い。除去食・ステロイドで症状コントロール可能な例が多い。",
    jrctSearchUrl: "https://jrct.niph.go.jp/search?query=Eosinophilic+Gastroenteritis",
    nanbyouInfoUrl: "https://www.nanbyou.or.jp/entry/99",
  },
  {
  ...
  {
    slug: "hht-hereditary",
    name: "遺伝性出血性毛細血管拡張症（HHT）",
    nameEn: "Hereditary Hemorrhagic Telangiectasia",
    nanbyoNumber: 227,
    category: "心・血管疾患",
    categorySlug: "cardiovascular",
    overview:
      "ENG・ACVRL1・SMAD4遺伝子変異による常染色体優性遺伝の血管奇形疾患。鼻出血・皮膚粘膜の毛細血管拡張症・内臓動静脈奇形（肺・肝・脳・消化管）を特徴とする。内臓AVM（動静脈奇形）による出血・右左短絡が生命を脅かす。",
    symptoms: ["反復する鼻出血（ほぼ全例）", "皮膚・口唇・手指の毛細血管拡張症", "肺動静脈奇形（血栓性脳梗塞・喀血）", "脳動静脈奇形（頭蓋内出血）", "肝動静脈奇形（心不全・肝硬変）", "消化管出血"],
    causes: "ENG（HHT1型）・ACVRL1（HHT2型）・SMAD4（HHT/若年性ポリポーシス合併型）遺伝子の常染色体優性変異。",
    diagnosis: "キュラソー基準（鼻出血・毛細血管拡張症・内臓AVM・家族歴）3項目以上で確定診断。遺伝子検査。",
    treatment: "鼻出血にレーザー焼灼・ベバシズマブ点鼻・全身投与。肺・脳・肝AVMにコイル塞栓術・外科切除。",
    prognosis: "適切なAVM管理により生命予後は改善。未治療の肺AVM（脳塞栓・喀血）・脳AVM（頭蓋内出血）が主要死因。",
    jrctSearchUrl: "https://jrct.niph.go.jp/search?query=Hereditary+Hemorrhagic+Telangiectasia",
    nanbyouInfoUrl: "https://www.nanbyou.or.jp/entry/227",
  },
  {
